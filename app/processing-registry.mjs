...
export const PDF_LITERAL_TEXT_PROCESSOR_VERSION = "poppler-layout-v2-c5.3.2";
export const PDF_SIGNATURE_METADATA_PROCESSOR_VERSION = "qpdf-signature-v1-c5.3.1";
export const PDF_STRUCTURE_INVENTORY_PROCESSOR_VERSION = "qpdf-structure-v2-c5.3.2";
